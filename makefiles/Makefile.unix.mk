...
#GTEST_INC = $(OR_ROOT)tools/googletest/include
...
DEPENDENCIES_INC = -I$(INC_DIR) -I$(GEN_DIR) \
 $(GTEST_INC) $(GFLAGS_INC) $(GLOG_INC) $(PROTOBUF_INC) \
 $(COIN_INC) \
 -Wno-deprecated -DUSE_GLOP -DUSE_BOP \
 $(GLPK_INC) $(SCIP_INC) $(GUROBI_INC) $(CPLEX_INC)

$(info GUROBI_INC = $(GUROBI_INC))
$(info DEPENDENCIES_INC = $(DEPENDENCIES_INC))
...
$(info CFLAGS = $(CFLAGS))
$(info DEPENDENCIES_LNK = $(DEPENDENCIES_LNK))
