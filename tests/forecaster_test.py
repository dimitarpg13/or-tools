...
dataset[0]=1.+0.j
dataset[N/100] = 10.+10.j
dataset[7*N/100] = 5.+1.j
dataset[15*N/100] = 3.-2.j
dataset[23*N/100] = 9.-1.j
dataset[31*N/100] = 12.-.5j
dataset[N-N/100] = 10.-10.j
dataset[N-7*N/100] = 5.-1.j
dataset[N-15*N/100] = 3.+2.j
dataset[N-23*N/100] = 9.+1.j
dataset[N-31*N/100] = 12.+.5j
idft = np.conj(dft(N))
